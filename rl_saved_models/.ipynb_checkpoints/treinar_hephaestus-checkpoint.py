...
def carregar_dados_do_ambiente():
    """
    Carrega os dados e inicializa o ambiente SFC_AllocationEnv_hephaestus.
    """
    try:
        list_graph = []
        list_sfc = []
    ...
    env = SFC_AllocationEnv_hephaestus(list_graph=list_graph, list_sfc=list_sfc, valid_nodes=valid_nodes)
