...
class NetworkPhysics:
    ...
    def calculate_5g_latency(
        ...
        pl_db = (28.0 + 22 * math.log10(dist) + 
                 20 * math.log10(config.freq_portadora_hz / 1e9))
        ...
        ruido_w_hz = BOLTZMANN_CONST * config.temperatura_kelvin * (10 ** (config.figura_ruido_db / 10))
