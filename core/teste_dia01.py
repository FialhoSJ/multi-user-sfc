...
def teste_dia_1():
    ...
    try:
        ...
        try:
            ...
            class MockSFC: id = "sfc_1"
            class MockVNF: 
                id = "vnf_1"
                def get_cpu_request(self): return 10
                def get_cache_request(self): return 0
        ...
        if node['is_active'] is True and node['cpu_capacity'] == 100:
            ...
            print(f"   [ERRO] Falha na recuperação. Active={node.get('is_active')}, CPU={node.get('cpu_capacity')}")
