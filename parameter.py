...
class Parameter:
    ...
    def __post__init__(self):
        ...
        self.ia_det_ft_bw = int(self.ia_bw + self.det_bw + \
            self.ft_bw)
        self.ia_det_ft = int(self.ia + self.det + self.ft)
        self.total = self.ia + self.det + self.ft + self.ma + \
            self.uni + self.re + self.ec_tc 
        self.mono = int(self.det + self.ft + self.ma + self.uni + \
            self.re + self.ec_tc)
