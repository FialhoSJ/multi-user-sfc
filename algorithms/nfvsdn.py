...
class Goku(Algorithm):
    ...
    def algorithm(self, substrate_network, sfc, shareable_sfs=None):
        ...
        net_info =substrate_network #O crasher da erro aqui  se eusar o deepcopy()
        ...
        for server in servers:
            ...
            server_resources[server]= {'cpu_capacity':cpu_capacity,'cache_capacity':cache_capacity,
                                           'cpu_used':cpu_used,'cache_used':cache_used,
                                           'cpu_free':cpu_free,'cache_free':cache_free,'position':old_server_resources[server]['position']}
