# def check_edge_bandwidth_sufficiency(
#     substrate_network, e1, e2, bandwidth_usage_info, bandwidth_request
# ):
...
#
# def check_path_bandwidth_sufficiency(
#     substrate_network, path, bandwidth_usage_info, bandwidth_request
# ):
#     length = len(path)
#     for i in range(0, length - 1):
#         e1 = path[i]
#         e2 = path[i+1]
#         res = check_edge_bandwidth_sufficiency(
#             substrate_network, e1, e2, bandwidth_usage_info, bandwidth_request
#         )
#         if res:
#
