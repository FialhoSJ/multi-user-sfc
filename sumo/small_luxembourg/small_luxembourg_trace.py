...
class Sumo_Small_Luxembourg:
    def __init__(self, config_file="sumo\small_luxembourg\luxembourg.sumocfg"):
    ...
    def create_(self,player,trip_id, vehicle_id, server_start, server_end):
        ...
        self.players_data[int(player)] = {'server_end':server_end,'start_edge': start_edge,'end_edge':end_edge,'trip_id':trip_id ,'coord': (x,y), 'closest_server': server_start,'player_on':1}
